...
#define BGCOLOR [UIColor colorWithRed:131/255.0 green:175/255.0 blue:155/255.0 alpha:1]
@interface CityListViewController ()<UIGestureRecognizerDelegate,UISearchBarDelegate,UITextFieldDelegate,ButtonGroupViewDelegate,MapDelegateCityName>
{
...
{
    location = [[locationMap alloc]init];
...
{
    _arrayLocatingCity = [NSMutableArray arrayWithObjects:location.cityDingWeiName, nil];
    NSLog(@"location*****%@",_arrayLocatingCity);
