...
#define kEncryptKey     @"m2FqV8GZSmTfaO47"
#define kIVKey          @"21152802792497201782483099668332"
...
//    memset((void *) iv, 0x0, (size_t) sizeof(iv));
    ...
    NSString *kiv = [kIVKey substringToIndex:kChosenCipherBlockSize];
    const char * a = [kiv UTF8String];
    uint8_t * iv = (uint8_t *)a;
