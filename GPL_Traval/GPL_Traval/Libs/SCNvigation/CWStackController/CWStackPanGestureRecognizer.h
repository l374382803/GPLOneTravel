...
typedef NS_ENUM(NSInteger, CWStackPanGestureRecognizerDirection) {
    ...
    CWStackPanGestureRecognizerDirectionUp,
	CWStackPanGestureRecognizerDirectionDown,
	CWStackPanGestureRecognizerDirectionLeft,
	CWStackPanGestureRecognizerDirectionRight
};
