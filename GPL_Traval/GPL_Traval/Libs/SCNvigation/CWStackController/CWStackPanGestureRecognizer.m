...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (currentLocation.x > previousLocation.x) {
        self.direction = CWStackPanGestureRecognizerDirectionRight;
    }
    else if (currentLocation.x < previousLocation.x) {
        self.direction = CWStackPanGestureRecognizerDirectionLeft;
    }
    else {
        self.direction = CWStackPanGestureRecognizerDirectionNone;
    }
    ...
    if (self.direction == CWStackPanGestureRecognizerDirectionRight) {
    ...
    if (self.direction == CWStackPanGestureRecognizerDirectionLeft) {
